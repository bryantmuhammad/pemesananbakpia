...
class CheckoutController extends Controller
{
    public function pay(Request $request)
    {
        ...
        $result['total']        = $total;
        $result['estimasi']     = $estimasi;
        return response()->json($result);
    }



    private function checkout($item_details, $transaction_details, $customerAddres)
    {
    ...
    private function getBeratAndTotal()
    {
    ...
    private function getOngkir($idkabupaten, $berat, $code, $service)
    {
        $ongkir     = 0;
        $estimasi   = 0;
